...
import { at as getAugmentedNamespace, av as getDefaultExportFromCjs } from "./chunks/astro/server_Bqlhq3Zt.mjs";
import { a as distExports } from "./chunks/astro-designed-error-pages_Bb6N5nBW.mjs";
import { s as sequence } from "./chunks/index_DAAkb-eO.mjs";
...
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_ZWxlY3RyaWMtdG9hZC0xNS5jbGVyay5hY2NvdW50cy5kZXYk", "SITE": "https://project-1000-t1k-tok-minimalist.vercel.app/", "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_mT8B6azLqIhYmRHBqHMz7X1dXl0SeYs4fxP26PLqNr", PUBLIC: process.env.PUBLIC })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.10.2"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.10.2",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_mT8B6azLqIhYmRHBqHMz7X1dXl0SeYs4fxP26PLqNr", PUBLIC: process.env.PUBLIC }).MODE
  },
  telemetry: {
