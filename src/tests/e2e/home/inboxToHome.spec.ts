...
test("navigate from inbox section to home and verify that 'For You' button is visible and the query params are correct", async ({
  page
}) => {
  // Go to the inbox URL
  await page.goto(inboxURL);

  // Verify that the inbox parameter in the URL is the expected one
