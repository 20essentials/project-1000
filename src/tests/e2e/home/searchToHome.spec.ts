...
test("navigate from search section to home and verify that 'For You' button is visible and the query params are correct", async ({
  page
}) => {
  // Go to the search URL
  await page.goto(searchURL);

  // Verify that the search parameter in the URL is the expected one
