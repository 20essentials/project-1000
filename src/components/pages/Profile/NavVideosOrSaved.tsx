...
const NAV_DATA = [
  {
    className: 'button-show-user-created-posts',
    svg: (
      <svg
        fill='currentColor'
        viewBox='0 0 48 48'
  ...
  {
    className: 'button-show-user-saved-posts',
    svg: (
      <svg
        fill='currentColor'
        viewBox='0 0 48 48'
  ...
  {
    className: 'button-show-user-loved-posts',
    svg: (
      <svg
        fill='currentColor'
        viewBox='0 0 48 48'
  ...
  {
    className: 'button-show-user-republish-posts',
    svg: (
      <svg
        fill='currentColor'
        viewBox='0 0 48 48'
...
export function NavVideosOrSaved({
  ...
  useEffect(() => {
    ...
    slideHorizontalRef.current.children[indexOfSectionActive].scrollIntoView({
      behavior: 'smooth',
      inline: 'center'
    });
  ...
  return (
    <article className='nav-videos-or-saved'>
      {NAV_DATA.map(({svg, className}, idx) => {
        const currentClassName = `aside-nav ${className} ${
          idx === indexOfSectionActive ? 'aside-nav-active' : ''
        }`;
        return (
          <aside
            key={idx}
