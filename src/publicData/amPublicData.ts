...
import { marshall_jassan_array_of_posts, marshall_jassan_commonProps } from './user-10-marshall-jassan';
import { edaserkanbolat_edits_array_of_posts, edaserkanbolat_edits_commonProps } from './user-11-edaserkanbolat-edits';
